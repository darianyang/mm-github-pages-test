...
## Postdocs
I have an opening for one postdoctoral researcher to join us in efforts funded by an NIH RO1 renewal titled “High-performance weighted ensemble software for simulation of complex bio-events.” The postdoc will develop and apply new methods involving the weighted ensemble strategy to simulate pathways and kinetics of milliseconds-to-seconds processes such as protein (un)binding, large-scale protein conformational transitions, and protein folding. Work may also interface with my lab’s collaboration with OpenEye Scientific to integrate the WESTPA software for weighted ensemble simulations with the Orion Cloud Computing Platform. The ideal candidate will have a strong background in scientific software development, experience with molecular dynamics simulations, and methods development. We encourage diversity of all types, and applications from women and minorities are particularly encouraged. 
