...
## Postdocs
I have an opening for one postdoctoral researcher to join us in the development of new methods to enable the simulation of pathways and kinetics for processes on the milliseconds to seconds timescales and beyond. These efforts are funded by an NIH RO1 renewal titled “High-performance weighted ensemble software for simulation of complex bio-events”. Applications may involve complex biological processes such as protein (un)binding, large-scale protein conformational transitions, and protein folding. Work may also interface with my lab’s collaboration with OpenEye Scientific to integrate the WESTPA software for weighted ensemble simulations with the Orion Cloud Computing Platform. 

The ideal candidate will have a strong background in scientific software development, experience with molecular dynamics simulations, and methods development. We encourage diversity of all types, and applications from women and minorities are particularly encouraged. 
